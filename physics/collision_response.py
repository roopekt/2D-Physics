...
from utility import divide_vectors_as_complex, multiply_vectors_as_complex
import math
...
def update_velocities(collision: Collision):
    ...
    relative_velocity = divide_vectors_as_complex(relative_velocity, collision.normal) #rotate so that x is in the direction of the normal
    ...
    #apply the impulses
    reaction_impulse_world_space = multiply_vectors_as_complex(reaction_impulse, collision.normal)
